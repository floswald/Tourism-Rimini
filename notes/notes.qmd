...
## So, for the government: how to grow tourism?
...
1. The problem of the commons: A publicly available resource will be depleted by profit maximizing entrepreneurs if limited in some way. Think of beaches or ski resorts.
...
* In cities, the problem is similar to mountains and beaches. We don't have public space to allocate, but *private* space: In a bed where a tourist sleeps, nobody else can sleep. In particular, no local resident can sleep there - except of course in rare cases where they sleep in one bed together, but this is not the subject of our concerns here. So, if it is difficult to build new housing for locals at the same rate as tourism increases, then there is an obvious shortage of space.
* With strong growth in Urban Tourism, what are the issues that cities face ?
* Policy makers need to confront a conflict between beneficiaries and people who only suffer from tourism in cities. 
* The proper response will take a stand on what is regarded as *fair* in some way. However, to make good policy, it is crucial to have a good understanding of the magnitudes at play.
...
![Figure by Aguilera, Artioli and Colomb, *Housing under Platform Capitalism*](../img/airbnb.png)
